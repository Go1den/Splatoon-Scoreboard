...
class Text(GraphicsObject):
    ...
    def setFace(self, face):
        if face in ['helvetica', 'arial', 'courier', 'times roman', 'motion control', 'digital-7', 'BigNoodleTooOblique', 'BigNoodleTitling', 'Project Paintball', 'Splatfont 2']:
    ...
    def setStyle(self, style):
        if style in ['bold', 'normal', 'italic', 'bold italic', 'oblique', 'regular']:
            f, s, b = self.config['font']
